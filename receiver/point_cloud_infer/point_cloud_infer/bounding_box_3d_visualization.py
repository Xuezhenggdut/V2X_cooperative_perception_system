...
class Detection3DArraySubscriber(Node):
    ...
    def bbox_callback(self, msg):
        ...
        print("bounding box visualization delay: ",
              stop_time.sec + stop_time.nanosec / 1e9 - (start_time.sec + start_time.nanosec / 1e9))
        ...
        def save_frame_info(frame_info):
            ...
            with open("frame_info_bbox_visualize.txt", 'a') as file:
                ...
                file.write(f"start_sec: {start_sec}, stop_sec:{stop_sec}\n")
