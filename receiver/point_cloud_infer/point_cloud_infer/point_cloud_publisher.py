...
class PCDPublisher(Node):
    ...
    def __init__(self, node_name: str):
        ...
        self.publisher = self.create_publisher(PointCloud2, 'point_cloud1', 100)
        self.ego_lidar_pose_publisher = self.create_publisher(TransformStamped, 'ego_lidar_pose1', 100)
    ...
    def timer_callback(self):
        ...
        # 发布ego_lidar_pose
        ego_lidar_pose_msg = TransformStamped()
        ego_lidar_pose_msg.header.frame_id = 'Lidar'
        ego_lidar_pose_msg.header.stamp = time_msg
        ego_lidar_pose_msg.transform.translation.x = lidar_pose[0]
        ego_lidar_pose_msg.transform.translation.y = lidar_pose[1]
        ego_lidar_pose_msg.transform.translation.z = lidar_pose[2]
        ego_lidar_pose_msg.transform.rotation.x = lidar_pose[3]
        ego_lidar_pose_msg.transform.rotation.y = lidar_pose[4]
        ego_lidar_pose_msg.transform.rotation.z = lidar_pose[5]
        ego_lidar_pose_msg.transform.rotation.w = float(num_str)
        self.ego_lidar_pose_publisher.publish(ego_lidar_pose_msg)
